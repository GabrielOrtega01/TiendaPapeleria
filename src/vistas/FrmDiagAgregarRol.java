...
public class FrmDiagAgregarRol extends javax.swing.JDialog {

    public FrmDiagAgregarRol(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtNombreRol, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 120, -1));
        ...
        jPanel1.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 40, 40));
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 40, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDiagAgregarRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDiagAgregarRol dialog = new FrmDiagAgregarRol(new javax.swing.JFrame(), true);
