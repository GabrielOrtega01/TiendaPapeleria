...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        submenuAdminRoles = new javax.swing.JMenuItem();
        ...
        submenuAdminRoles.setText("Admin roles");
        submenuAdminRoles.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                submenuAdminRolesActionPerformed(evt);
            }
        });
        menuConfiguracion.add(submenuAdminRoles);

        submenuAdmPersonas.setText("Admin personas");
        submenuAdmPersonas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                submenuAdmPersonasActionPerformed(evt);
            }
        });
        menuConfiguracion.add(submenuAdmPersonas);
    ...
    private void submenuAdmPersonasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submenuAdmPersonasActionPerformed
        FrmDiagAdminPersonas objFrmDiagAdmPer = new FrmDiagAdminPersonas(this, true);
    ...
    private void submenuAdminRolesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submenuAdminRolesActionPerformed
        FrmDiagAdminRoles objFrmDiagAdmRol = new FrmDiagAdminRoles(this, true);
        objFrmDiagAdmRol.setLocationRelativeTo(null);
        objFrmDiagAdmRol.setVisible(true);
    }//GEN-LAST:event_submenuAdminRolesActionPerformed
    ...
    private javax.swing.JMenuItem submenuAdminRoles;
